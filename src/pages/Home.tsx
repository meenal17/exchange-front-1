  ...
  return (
    <Body>
      <Container>
        <Bannerheading>
          <Mytextto>
            ...
            <br /> Where <span className='mytexfdxdd'>Trust</span>  meets <span className='mytexfdxdd'>
            Needs</span> 
          </Mytextto>
          <Bannertxt>
          ...
          <Buttondiv>
            <div className="LaunchButton"> <span className='textnew'>
            Launch Swap</span> </div>
          </Buttondiv>
        </Bannerheading>
      </Container>
      {/* section two start  */}
      ...
      <Container>
        ...
        <Sectiotwosection>{/* <Carsole/> */}</Sectiotwosection>
      </Container>
      {/* section four start */}
      <Container>
        <Bannerheading>
          <Mytext>Supported Networks</Mytext>
        </Bannerheading>
