        ...
        <div className="card ">
          ...
          <div className="inner_part">
            ...
            <div className="content content_1">
              ...
              <div className="text">
                ...
                adipisicing elit. Lorem ipsum dolor sit amet consect. Lorem ipsum dolor sit amet consectetur .
              </div>
          ...
          <div className="inner_part">
            ...
            <div className="content content_2">
              ...
              <div className="text">
                Ankara is Turkey's beating heart, second largest city, located in the Central Anatolia region and home
          ...
          <div className="inner_part">
            ...
            <div className="content content_3">
              ...
              <div className="text">
                Located on the shores of the Aegean Sea, west of the Anatolian Peninsula, İzmir is the third-largest
                city in Turkey.
              </div>
              <div className="button-wrapper ">
            <div className="LaunchButton">
